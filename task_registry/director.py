from task_registry.task.browser.const import LAUNCH_BOOKMARK_REQUEST, LAUNCH_URL_REQUEST
from task_registry.task.browser.handler import LaunchBookmarkHandler, LaunchUrlHandler
from task_registry.task.browser.model import build_launch_bookmark_request
from task_registry.task.joke.const import GET_JOKE_REQUEST
from task_registry.task.joke.handler import GetJokeHandler
from task_registry.task.joke.model import build_get_joke_request
from task_registry.task.translation.const import GET_TRANSLATION_REQUEST
from task_registry.task.translation.handler import GetTranslationHandler
from task_registry.task.translation.model import build_get_translation_request
