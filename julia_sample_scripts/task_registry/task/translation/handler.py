...
from julia_sample_scripts.task_registry.task.translation.const import TRANSLATION, TRANSLATE, GET_TRANSLATION_RESPONSE
from julia_sample_scripts.task_registry.task.translation.model import GetTranslationRequest, GetTranslationResponse
